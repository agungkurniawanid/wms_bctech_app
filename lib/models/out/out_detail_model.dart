class OutDetailModel {
  ...
  double? priceactual;
  double? priceentered;
  String? pricelist; // <-- DIPERBAIKI: Tipe diubah dari double? ke String?
  double? qtydelivered;
  int? qtyEntered;
  double? qtyinvoiced;
  double? qtyordered;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'pricelist': pricelist, // <-- DIPERBAIKI
  ...
  factory OutDetailModel.fromJson(Map<String, dynamic> data) {
    return OutDetailModel(
      ...
      priceentered: (data['priceentered'] is num)
          ...
          : 0.0,
      pricelist:
          data['pricelist']?.toString() ??
          '', // <-- DIPERBAIKI: Baca sebagai String
      qtydelivered: (data['qtydelivered'] is num)
          ? (data['qtydelivered'] as num).toDouble()
          : 0.0,
      qtyEntered:
          data['qtyentered']?.toInt() ??
          0, // <-- DIPERBAIKI: Key 'qtyentered' (lowercase)
  ...
  OutDetailModel.clone(OutDetailModel data) {
    ...
    pricelist = data.pricelist; // <-- DIPERBAIKI
