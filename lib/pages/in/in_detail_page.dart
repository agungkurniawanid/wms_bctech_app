...
class _InDetailPageState extends State<InDetailPage>
  ...
  void _saveScanResult(InDetail product) async {
    ...
    try {
      ...
      _logger.d('✅ Serial number valid, menyimpan ke Firestore...');

      // ✅ SAVE TANPA NAVIGASI, TANPA MENUTUP BOTTOM SHEET
      await _saveToFirestore(
        product,
        serialNumber,
        quantity,
        shouldCloseBottomSheet: false, // ✅ JANGAN TUTUP BOTTOM SHEET
        shouldNavigate: false, // ✅ JANGAN NAVIGASI
      );

      Fluttertoast.showToast(
        msg: "Serial number berhasil disimpan: $serialNumber",
        backgroundColor: Colors.green,
        textColor: Colors.white,
      );

      // ✅ TUTUP BOTTOM SHEET SECARA MANUAL
      ...
      // ✅ TUNGGU SEBENTAR LALU AUTO-RESTART SCANNER
      await Future.delayed(const Duration(milliseconds: 500));

      if (mounted) {
        // ✅ TAMPILKAN ULANG SCANNER UNTUK SCAN BERIKUTNYA
      ...
      // Tutup bottom sheet jika ada error
      if (mounted && Navigator.of(context).canPop()) {
        Navigator.of(context).pop();
      }
    }
  ...
  void _saveManualInput(InDetail product) async {
    ...
    try {
      ...
      // ✅ SAVE TANPA NAVIGASI DAN TANPA MENUTUP BOTTOM SHEET OTOMATIS
      await _saveToFirestore(
        product,
        hasSerialNumber ? serialNumber : null,
        quantity,
        shouldCloseBottomSheet: false, // ✅ JANGAN TUTUP BOTTOM SHEET OTOMATIS
        shouldNavigate: false, // ✅ JANGAN NAVIGASI
      );
      ...
      Fluttertoast.showToast(
        msg: hasSerialNumber
            ? "Data dengan serial number berhasil disimpan"
      ...
      // ✅ TETAP DI HALAMAN INI - TIDAK ADA NAVIGASI
      // User bisa melanjutkan input product lain dari list
    } catch (e) {
      // Show error message
      Fluttertoast.showToast(
        msg: "Gagal menyimpan: $e",
  ...
  Future<void> _saveToFirestore(
    ...
    try {
      ...
      if (hasSerialNumber) {
        ...
        _logger.d('✅ Serial number valid dan unik: $trimmedSerial');
      }
