...
import 'package:wms_bctech/components/delivery_order/delivery_order_add_button_widget.dart';
import 'package:wms_bctech/components/delivery_order/delivery_order_appbar_widget.dart';
import 'package:wms_bctech/components/delivery_order/delivery_order_empty_widget.dart';
import 'package:wms_bctech/components/delivery_order/delivery_order_header_widget.dart';
import 'package:wms_bctech/components/delivery_order/delivery_order_shimmer_widget.dart';
...
class _DeliveryOrderPageState extends State<DeliveryOrderPage> {
  final DeliveryOrderController _deliveryOrderController =
      Get.find<DeliveryOrderController>();
  ...
  @override
  void dispose() {
    _logger.d('🧹 DeliveryOrderPage dispose');
  ...
  void _startSearch() {
    ...
    try {
      _deliveryOrderController.setSearchMode(true);
    } catch (e, stackTrace) {
  ...
  void _clearSearchQuery() {
    ...
    try {
      ...
      _deliveryOrderController.clearSearch();
            ...
            Flexible(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${_deliveryOrderController.totalLoaded} items total',
                    style: TextStyle(
                      fontFamily: 'MonaSans',
                      fontSize: 11.0,
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    DeliveryOrderConstant.primaryColor.withValues(alpha: 0.1),
                    DeliveryOrderConstant.primaryColor.withValues(alpha: 0.05),
                  ],
                ),
                shape: BoxShape.circle,
              ),
              child: Icon(
                ...
                size: 56,
                color: DeliveryOrderConstant.primaryColor.withValues(
                  alpha: 0.6,
                ),
              ),
            ),
            ...
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                foregroundColor: DeliveryOrderConstant.primaryColor,
                side: BorderSide(color: DeliveryOrderConstant.primaryColor),
  ...
  Widget _buildSearchResultCard(DeliveryOrderModel grin) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: DeliveryOrderConstant.primaryColor.withValues(alpha: 0.08),
            blurRadius: 12,
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          borderRadius: BorderRadius.circular(16),
          splashColor: DeliveryOrderConstant.primaryColor.withValues(
            alpha: 0.1,
          ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            DeliveryOrderConstant.primaryColor.withValues(
                              alpha: 0.12,
                            ),
                            DeliveryOrderConstant.primaryColor.withValues(
                              alpha: 0.06,
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 15,
                                    color:
                                        DeliveryOrderConstant.textPrimaryColor,
                                    fontWeight: FontWeight.w600,
                                    letterSpacing: -0.2,
                                  ),
                                ),
  ...
  Widget _buildAddButton(DeliveryOrderModel grinData) {
    return InkWell(
      ...
      child: Container(
        ...
        height: 40,
        decoration: BoxDecoration(
          color: DeliveryOrderConstant.primaryColor.withValues(alpha: 0.1),
          shape: BoxShape.circle,
          border: Border.all(
            color: DeliveryOrderConstant.primaryColor.withValues(alpha: 0.3),
            width: 1,
          ),
        ),
        child: Icon(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [
                DeliveryOrderConstant.primaryColor.withValues(alpha: 0.05),
                DeliveryOrderConstant.primaryColor.withValues(alpha: 0.02),
              ],
            ),
            border: Border.all(
              color: DeliveryOrderConstant.primaryColor.withValues(alpha: 0.3),
  ...
  Widget build(BuildContext context) {
    final isInSearchMode = _deliveryOrderController.isSearching.value;
    ...
    return PopScope(
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          appBar: DeliveryOrderAppbarWidget(
            isSearching: isInSearchMode, // GUNAKAN STATE DARI CONTROLLER
            onBackPressed: _handleBackPress,
            onClearSearch: _clearSearchQuery,
            onRefresh: _deliveryOrderController.handleRefreshDeliveryOrderPage,
            onStartSearch: _startSearch,
            deliveryOrderController: _deliveryOrderController,
            searchController: _searchController,
            onSearchChanged: _onSearchChanged,
          ),
          backgroundColor: DeliveryOrderConstant.backgroundColor,
