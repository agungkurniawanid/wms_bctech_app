...
class DeliveryOrderHeaderWidget extends StatelessWidget {
  ...
  const DeliveryOrderHeaderWidget({
    super.key,
    ...
    return Obx(
      () => Container(
        ...
        decoration: BoxDecoration(
          color: DeliveryOrderConstant.cardColor,
  ...
  Widget _buildSortDropdown() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.sort, color: DeliveryOrderConstant.primaryColor, size: 18),
