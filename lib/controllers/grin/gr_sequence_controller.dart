...
class GrSequenceService extends GetxService {
  ...
  static const String grinCollection = 'gr_in';
  ...
  Future<List<int>> _findCancelledSequencesFromToday() async {
    try {
      ...
      try {
        ...
        _logger.w('Could not query gr_in for cancelled sequences: $e');
      }
    ...
    try {
      ...
      try {
        ...
        if (lastGrQuery.docs.isNotEmpty) {
          ...
          if (sequence != null) {
            _logger.d('Last successful sequence from gr_in: $sequence');
            return sequence;
          }
        }
      } catch (e) {
        _logger.w('Could not query gr_in for last sequence: $e');
      }
