          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [hijauGojek, hijauGojek.withOpacity(0.8), Colors.white],
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              // Semua Logo sejajar (BC Tech + 3 Partners)
                              Container(
                              ...
                              // Title IM MOBILE dengan gradient dan shadow
                              ShaderMask(
                                shaderCallback: (bounds) => LinearGradient(
                                  colors: [
                                    hijauGojek,
                                    hijauGojek.withOpacity(0.7),
                                  ],
                                ).createShader(bounds),
                                child: const Text(
                                  'IM MOBILE',
                              ...
                              // Division Dropdown dengan styling menarik
                              ...
                              // Email Field dengan label terpisah
                              ...
                              // Password Field dengan label terpisah
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [
                                      hijauGojek,
                                      hijauGojek.withOpacity(0.8),
                                    ],
                                  ),
                                  borderRadius: BorderRadius.circular(16),
                                  boxShadow: [
                                    BoxShadow(
                                      color: hijauGojek.withOpacity(0.4),
                                      blurRadius: 15,
                                ...
                                child: BtnWidget(
                                  ...
                                  onPressed: () {
                                    if (_formKey.currentState?.validate() ==
                                      ...
                                      // Anda bisa menggunakan _selectedDivision di sini
                                      print(
